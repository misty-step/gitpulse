...
export default function DashboardLoadingState() {
  return (
    <div className="h-screen flex flex-col">
      {/* Animated header */}
      <div className="p-1.5 border-b" style={{ borderColor: 'var(--neon-green)', backgroundColor: 'rgba(249, 250, 251, 0.8)' }}>
        <div className="animate-pulse h-8 w-40 rounded" style={{ backgroundColor: 'rgba(16, 185, 129, 0.2)' }}></div>
      </div>
      
      <div className="flex flex-1 overflow-hidden">
        {/* Animated sidebar */}
        <div className="w-64 p-1.5 border-r" style={{ borderColor: 'var(--electric-blue)', backgroundColor: 'rgba(249, 250, 251, 0.8)' }}>
        ...
        <div className="flex-1 p-2 overflow-auto">
          <div className="space-y-6 max-w-5xl mx-auto">
            <div className="flex justify-between items-center">
              <div className="animate-pulse h-8 w-64 rounded" style={{ backgroundColor: 'rgba(16, 185, 129, 0.15)' }}></div>
              <div className="animate-pulse h-8 w-32 rounded" style={{ backgroundColor: 'rgba(16, 185, 129, 0.15)' }}></div>
            </div>
            
            <div className="grid grid-cols-3 gap-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="p-1.5 border rounded-md" style={{ borderColor: 'var(--electric-blue)', backgroundColor: 'rgba(249, 250, 251, 0.8)' }}>
            ...
            <div className="border rounded-md p-5" style={{ borderColor: 'var(--neon-green)', backgroundColor: 'rgba(249, 250, 251, 0.8)' }}>
              <div className="animate-pulse h-6 w-48 rounded mb-4" style={{ backgroundColor: 'rgba(16, 185, 129, 0.2)' }}></div>
