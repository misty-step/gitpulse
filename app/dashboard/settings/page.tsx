    ...
    <div className="max-w-2xl mx-auto space-y-12 pb-24">
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
           <h2 className="text-sm font-semibold uppercase tracking-wider text-foreground">Connection</h2>
           {isGitHubConnected && (
          ...
          {isGitHubConnected ? (
            ...
            <div className="text-center py-8 space-y-4">
              <p className="text-sm text-muted max-w-sm mx-auto">
                Connect your GitHub account to enable automated intelligence gathering.
              </p>
              <button
                onClick={handleConnectGitHub}
      ...
      <section className="space-y-6">
        <h2 className="text-sm font-semibold uppercase tracking-wider text-foreground">Schedule</h2>
        ...
        <div className="bg-surface border border-border p-6 space-y-8">
          ...
          <div className="space-y-6 pt-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center border transition-colors ${
                  dailyEnabled ? "bg-foreground border-foreground" : "bg-transparent border-border"
                }`}
              >
                <span
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-foreground">Weekly Retrospective</p>
                <p className="text-xs text-muted">7-day summary (Mondays).</p>
              </div>
              <button
                onClick={() => setWeeklyEnabled(!weeklyEnabled)}
                className={`relative inline-flex h-6 w-11 items-center border transition-colors ${
                  weeklyEnabled ? "bg-foreground border-foreground" : "bg-transparent border-border"
                }`}
              >
                <span
                  className={`inline-block h-3 w-3 transform bg-background transition-transform ${
      ...
      <section>
        ...
        >
          <div>
            <h2 className="text-sm font-medium text-foreground">Manage Sources</h2>
            <p className="text-xs text-muted mt-1">Configure repositories and organizations.</p>
          </div>
