          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600">
                We&apos;ll automatically discover all your repositories and start
                ...
                <div className="text-center space-y-4">
                  ...
                  <div>
                    <p className="text-lg font-medium text-gray-900">
                      Connected as @{convexUser.githubUsername ?? convexUser.ghLogin}
                    </p>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 text-sm text-blue-700">
                  ...
                  <ul className="space-y-1">
                    <li>• Read access to your public and private repositories</li>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                We&apos;ll automatically discover and sync all repositories you have
                access to. No manual selection needed!
              </p>
              <div className="flex gap-3">
                <button
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 text-sm text-green-700">
                  ...
                  <p>
                    ...
                    AM {timezone ? `(${timezone.split("/").pop()?.replace(/_/g, " ")} time)` : ""}.
